...
<div class="container">
	...
	<div class="container">
		<form name="loginF" action="loginEnd.jsp" method="post"
			...
			<!-- onsubmit이벤트 핸들러는 form이 전송될때 실행된다. onsubmit에서 호출하는 함수의 변화값에 따라 전송 여부를 결정한다.
			...
			<table border="1" style="width: 60%; margin: auto">
				<tr>
					...
					<td width=80% class="m2"><input type="text" name="userid"
						value="<%=uid%>" id= "userid" placeholder="User ID"></td>
				</tr>
				<tr>
					<td width=20% class="m1"><b>비밀번호</b></td>
					<td width=80% class="m2"><input type="password" name="pwd"
						id="pwd" placeholder="Password"></td>
				</tr>
				<tr>
					<td colspan="2" class="container"><label for="saveId">
							<input type="checkbox" name="saveId" <%=(flag)?"checked":"" %>id="saveId">아이디 저장
					</label>
						<button id="btnLogin">로그인</button></td>
					<!-- default가 submit버튼 -->
				</tr>
			</table>
		</form>
