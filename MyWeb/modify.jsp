		...
		<table border="1" style="width: 90%; margin: auto; margin-top: 2em">
			<tr>
				...
				<td width="80%" class="m2"><input type="text" name="name"
					value="<%=user.getName()%>" id="name" placeholder="Name"> <br>
					<span class='ck'>*이름은 한글만 가능해요</span></td>
			</tr>
			<tr>
				<td width="20%" class="m1"><b>아이디</b></td>
				<td width="80%" class="m2"><input type="text" name="userid"
					value="<%=user.getUserid()%>" id="userid" readonly
					placeholder="User ID">
					<button type="button" onclick="open_idcheck()">아이디 중복 체크</button> <br>
					<span class='ck'>*아이디는 영문자, 숫자, _, !만 사용 가능해요 </span></td>
			</tr>
			<tr>
				<td width="20%" class="m1"><b>비밀번호</b></td>
				<td width="80%" class="m2"><input type="password" name="pwd"
					id="pwd" placeholder="Password"> <br> <span class='ck'>*비밀번호는
						문자,숫자,!,. 포함해서 4~8자리 이내 </span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="80%" class="m2"><input type="text" name="hp1"
					value="<%=user.getHp1()%>" id="hp1" placeholder="HP1">- <input
					type="text" name="hp2" value="<%=user.getHp2()%>" id="hp2"
					placeholder="HP2">- <input type="text" name="hp3"
					value="<%=user.getHp3()%>" id="hp3" placeholder="HP3"> <br>
			...
			<tr>
				...
				<td width="80%" class="m2"><input type="text" name="post"
					value="<%=user.getPost()%>" id="post" placeholder="Post">
					<button type="button">우편번호 찾기</button></td>
			</tr>
			<tr>
				<td width="20%" class="m1"><b>주소</b></td>
				<td width="80%" class="m2"><input type="text" name="addr1"
					value="<%=user.getAddr1()%>" id="addr1" placeholder="Address1"><br>
					<input type="text" name="addr2" value="<%=user.getAddr2()%>"
					id="addr2" placeholder="Address2"></td>
			</tr>
			<tr>
				<td width="20%" class="m1"><b>마일리지</b></td>
				<td width="80%" class="m2"><b><%=user.getMileage()%>점</b></td>
			</tr>
			<tr>
				<td width="20%" class="m1"><b>회원상태</b></td>
				<td width="80%" class="m2"><b
					class="state<%=user.getStatus()%>"><%=user.getStatusStr()%></b> <br>
